<?php
/**
 * HelloWorld SpecialPage for sectionExtension extension
 *
 * @file
 * @ingroup Extensions
 */
...
class SpecialHelloWorld extends SpecialPage {
	...
	public function execute( $sub ) {
		...
		$out->setPageTitle( $this->msg( 'sectionextension-helloworld' ) );

		$out->addHelpLink( 'How to become a MediaWiki hacker' );

		$out->addWikiMsg( 'sectionextension-helloworld-intro' );
